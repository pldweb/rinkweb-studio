...
const Contact: React.FC = () => {
  return (
    <>
      <SEO 
        title="Hubungi Kami"
        description="Hubungi Rinkweb Studio untuk mendiskusikan kebutuhan website dan digital marketing bisnis Anda. Tim kami siap membantu Anda."
        keywords="Kontak Rinkweb Studio, Hubungi Kami, Konsultasi Website, Konsultasi Digital Marketing, Jasa Website"
        canonicalUrl="https://rinkweb.studio/hubungi"
      />
      <main>
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-md mb-8">
            <h2 className="text-2xl font-semibold mb-4">Kami Siap Membantu Anda</h2>
            <p className="mb-4">
              Apakah Anda memiliki pertanyaan tentang layanan kami atau ingin mendiskusikan proyek? 
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@rinkwebstudio.com</p>
                  </div>
                </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-md mb-12">
            ...
            <div className="aspect-w-16 aspect-h-9">
              <div className="w-full h-64 bg-gray-300 rounded-lg flex items-center justify-center">
                ...
                {/* Di sini Anda dapat menambahkan peta Google Maps atau peta lainnya */}
              </div>
            </div>
          </div>
          </div>
