              ...
              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto md:mx-0">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <a href={wa} className="bg-primary hover:bg-primary-600 text-white px-6 py-3 rounded-md font-medium transition-all md:max-w-full max-w-[%] duration-200 shadow-md hover:shadow-lg flex items-center justify-center">
                      {slide.ctaText}
