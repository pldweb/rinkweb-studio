          ...
          {packages.map((pkg) => (
            ...
            >
              ...
              <div className={`p-8 ${pkg.custom ? 'text-white' : ''}`}>
                ...
                <a target='_blank' href='https://wa.me/62895365441554?text=Halo,%20saya%20tertarik%20dengan%20layanan%20Rinkweb%20Studio%0A%0ABisakah%20kita%20agendakan%20diskusi?'
